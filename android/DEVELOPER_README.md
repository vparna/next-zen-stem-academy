...
The web assets (HTML/CSS/JS) are already bundled inside:
```
app/src/main/assets/public/
```
No need to run any web build commands — everything is ready.

### ✅ Capacitor Config Already Included
The Capacitor configuration is already synced at:
```
